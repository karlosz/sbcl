...
(defun %code-debug-info-addr (code)
  (sap-ref-word (int-sap
                 (logandc2 (get-lisp-obj-address code) lowtag-mask))
...
(defun extract-fun-map (code core)
  ...
  (let* ((di-sap (int-sap (%code-debug-info-addr code)))
...
(defun get-code-segments (code vaddr core)
  (let ((di (get-lisp-obj-address (sap-int (%code-debug-info-addr code))))
